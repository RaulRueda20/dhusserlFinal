...
function processList(
  ...
  const termId = id;
  const filter = [id, lista[index].refid];
  const queryString0 =
    "\
    select distinct\
    ...
    .then(function (results) {
      ...
      if (index == 0) {
        ...
        if (expresion_aleman > 0) {
          htmlContent +=
            t1 +
            basics.expresion_original +
            "</h5>\
                    <ul>";
          if (referencia_aleman > 0) {
            for (let i in complex) {
              htmlContent +=
                "<small>" + complex[i].ref_original + "</small><br/>";
            }
          }
        ...
        if (expresion_espaniol > 0) {
          ...
          if (referencia_espaniol > 0) {
            for (var i in complex) {
              ...
              htmlContent +=
                "<small>" + complex[i].ref_traduccion + "</small><br/>";
            }
          }
          htmlContent += "</ul></div></div><hr/>";
        }
                ...
                .then(function (results3) {
                  ...
                  if (hierarchy > 0 && index == 0) {
                    ...
                    if (jerarquia.abuelos.length > 0) {
                      for (let a in jerarquia.abuelos) {
                        htmlContent +=
                          "<div style='margin-top: 15px;'><h6><strong>" +
                          jerarquia.abuelos[a].expresion +
                          " // " +
                          jerarquia.abuelos[a].traduccion +
                          "</strong> </h6></div>";
                        htmlContent +=
                          "<div style='margin-bottom: 15px'><small>" +
                          jerarquia.abuelos[a].pasaje_original +
                          " // " +
                          jerarquia.abuelos[a].pasaje_traduccion +
                          "</small></div>";
                      }
                    } else {
                      htmlContent +=
                    ...
                    if (jerarquia.hijos.length > 0) {
                      for (let h in jerarquia.hijos) {
                        htmlContent +=
                          "<div style='margin-top: 15px;'><h6><strong>" +
                          jerarquia.hijos[h].expresion +
                          " // " +
                          jerarquia.hijos[h].traduccion +
                          "</strong> </h6></div>";
                        htmlContent +=
                          "<div style='margin-bottom: 15px;'><small>" +
                          jerarquia.hijos[h].pasaje_original +
                          " // " +
                          jerarquia.hijos[h].pasaje_traduccion +
                          "</small></div>";
                      }
                    } else {
                      htmlContent +=
                  ...
                  if (pasaje_aleman > 0)
                    htmlContent +=
                      ...
                      basics.pasaje_original +
                      "</div>\
                                                    </div><br/>";
                  if (pasaje_espaniol > 0)
                    htmlContent +=
                      "<div>" +
                      t8 +
                      "<div style='padding : 10px 40px;'>" +
                      basics.pasaje_traduccion +
                      "</div>\
                                                        </div><br/></div>";
                  htmlRes += htmlContent;
                  return processList(
  ...
  res.locals.connection
    ...
    .then(function (results) {
      processList(
        ...
        "",
        req.query.lang,
        req.query.expresion_aleman,
        req.query.referencia_aleman,
        req.query.expresion_espaniol,
        req.query.referencia_espaniol,
        req.query.hierarchy,
        req.query.pasaje_aleman,
        req.query.pasaje_espaniol,
        (resultado) => {
              ...
              .then(function (results2) {
                ...
                res.locals.connection
                  ...
                  .then(function (results3) {
                    ...
                    if (req.query.pasaje_espaniol > 0)
                      htmlContent +=
                        "<div>" +
                        t8 +
                        "<div style='padding : 10px 40px;'>" +
                  ...
                  .then(function (results3) {
                    ...
                    if (req.query.hierarchy > 0) {
                      ...
                      if (jerarquia.abuelos.length > 0) {
                        ...
                        htmlContent +=
                          "<div><h6><strong>" + t10 + "</strong></h6></div>";
                      }
                      htmlContent += t6;
                      if (jerarquia.hijos.length > 0) {
                        for (var h in jerarquia.hijos) {
                        ...
                        htmlContent +=
                          "<div><h6><strong>" + t9 + "</strong></h6></div>";
                      }
                    } else {
                      var actual = "";
                      htmlContent += t5;
                    ...
                    if (req.query.pasaje_aleman > 0)
                      htmlContent +=
                        "<div id='pasaje'>" +
                        t7 +
                        "<div style='padding : 10px 40px;'> id='pasaje'" +
                        basics.pasaje_original +
                        "</div>\
                            </div>";
                    if (req.query.pasaje_aleman && req.query.pasaje_espaniol)
                      htmlContent += "<hr/>";
                    if (req.query.pasaje_espaniol > 0)
                      htmlContent +=
                        "<div id='pasaje'>" +
                    ...
                    const htmltitle = randomstring.generate(10);
                    const text = htmlToText.fromString(htmlContent, {
                      wordwrap: 130,
                    });
                    fs.writeFile(
                      filesRoute + htmltitle + ".txt",
                      text,
                      function (err) {
                        if (err) console.log(err);
                        else
