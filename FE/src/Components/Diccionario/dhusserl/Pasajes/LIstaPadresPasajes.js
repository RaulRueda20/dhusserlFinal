...
const ListaPadresPasajes = (props) => {
  ...
  const handleClickDerivadaDe = (event) => {
    ...
    webService(
      "/expresiones/" + props.language + "/abuelosList/" + pid,
      "GET",
      {},
      global.sesion,
      ({ data }) => {
    ...
    webService(
      "/expresiones/" + props.language + "/hijosList/" + pid,
      "GET",
      {},
      global.sesion,
      ({ data }) => {
    ...
    <Fragment>
      <li key={props.padre.refid + "-" + props.index}>
        <Grid container alignItems="center">
          ...
          >
            <MenuItem>
              <b>{menuDerechoJerarquiaDerivadaDe(props.lang)}</b>
            </MenuItem>
            <Divider />
            {padreDePadres.length < 1 ? (
              <MenuItem>{noDerivaDe(props.lang)}</MenuItem>
            ) : (
            ...
            <Divider />
            <MenuItem>
              <b>{menuDerechoJerarquiaExpresionesDerivadas(props.lang)}</b>
            </MenuItem>
            <Divider />
