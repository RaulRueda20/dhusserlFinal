    ...
    <Fragment>
      <li
        className={classNames([
          {
            pasajeSeleccionado:
              props.expresion.id == props.expresionSeleccionada.id,
          },
          "sideList",
        ])}
        key={props.expresion.id + "-" + props.index}
        id={"expresion" + props.expresion.id}
      ...
      >
        <Grid container justify="center" alignItems="center">
          ...
          <Grid item xs={1}>
            <div
              id={props.expresion.id + "/" + props.expresion.expresion}
              onClick={props.getJerarquia}
            >
